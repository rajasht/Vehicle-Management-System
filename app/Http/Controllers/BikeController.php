...
/**
 * Class for methods related to Bike
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Sagnik Mandal <sagnik@shorthillstech.com>
...
class BikeController extends Controller
{
     ...
     * Searches all bikes having the on road price
     * range passed using whereBetween function
     * Ensure Bike Status of active category by record_status 1
     *
     ...
     * Searches all bikes having engine displacement
     * CC range passed using whereBetween function
     * Ensure Bike Status of active category by record_status 1
     *
     ...
     * Searches all bikes having the kmpl_mileage
     * range passed using whereBetween function
     * Ensure Bike Status of active category by record_status 1
     *
