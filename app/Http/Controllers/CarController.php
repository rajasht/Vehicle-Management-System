...
/**
 * Class for methods related to Car
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Sagnik Mandal <sagnik@shorthillstech.com>
...
class CarController extends Controller
{
    ...
    public function getByCarName($carName)
    {
        ...
        return response()->json(
            ...
            "success" => "false",
            "code" => 404,
            "message" => "No records found of car data 
                with car name matching with $carName"
            ],
            404
        );
    }
    ...
    public function getByBrand($brand)
    {
        ...
        return response()->json(
            ...
            "code" => 404,
            "message" => "No records found of car data 
                with brand name matching with $brand"
            ],
            404
        );
    }
    ...
    public function getByTransmission($tr)
    {
        ...
        if (count($car)) {
            return response()->json(
                ...
                "success" => "true",
                "code" => 200,
                "message" => "Found car data with transmission 
                    type matching with $tr",
                "data" => $car
                ],
                200
            );
        ...
        return response()->json(
            ...
            "code" => 404,
            "message" => "No records found of car data 
                with transmission type matching with $tr"
            ],
            404
        );
    }
    ...
    public function getByFuelType($ft)
    {
        ...
        return response()->json(
            ...
            "success" => "false",
            "code" => 404,
            "message" => "No records found of car data with 
                fuel type matching with $ft"
            ],
            404
        );
    }
     ...
     *
     * @param $price_start starting price in rupees
     * @param $price_end   final price in rupees
     *
     * @return \Illuminate\Http\Response
     */
    ...
    /**
     * Displays the contents on the vms dashboard
     *
     * @param $request \Illuminate\Http\Request
     *
     * @return \Illuminate\Http\Response
    ...
    /**
     * Displays the car listing of customer
     *
     * @param $request \Illuminate\Http\Request
     *
     * @return \Illuminate\Http\Response
